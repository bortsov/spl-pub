...
#define SMC_DRM_STATADDR_REG0			(SUNXI_SMC_BASE + 0x0060)
#define SMC_DRM_STATADDR_REG1			(SUNXI_SMC_BASE + 0x0064)
#define SMC_DRM_ENDADDR_REG0			(SUNXI_SMC_BASE + 0x0068)
#define SMC_DRM_ENDADDR_REG1			(SUNXI_SMC_BASE + 0x006C)
